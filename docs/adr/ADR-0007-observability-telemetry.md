...
> **Superseded (2026-06-10):** The dashboard/metrics platform defined here was never adopted operationally. Replaced by the slim alert-only pipeline in ADR-0023. Host-level log collection (ADR-0013) remains in force.


**Date:** 2025-11-10  
**Status:** Superseded by ADR-0023 (Slim Log-Based Alerting)
**Deciders:** Owner  
**Supersedes:** None  
