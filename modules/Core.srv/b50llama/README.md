...
> **DEPRECATED (2026-07-13):** superseded by [`../llm-b-b50/`](../llm-b-b50/)
> per ADR-0024 and issue #127 — vLLM on the Intel XPU backend, same GPU. This
> stack is left in place and untouched (not removed) until the human-executed
> decommission step per epic #124 / #129. The two stacks cannot run
> concurrently — both need the full 16GB of B50 VRAM.
